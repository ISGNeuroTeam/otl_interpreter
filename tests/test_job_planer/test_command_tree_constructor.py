...
class TestCommandPipelineState(TestCase):
    ...
    def test_add_awaited_command_tree(self):
        command1 = CommandTree(Command(name='command1'))
        command2 = CommandTree(Command(name='command2'))
        command3 = CommandTree(Command(name='command3'))
    ...
    def test_override_previous_command_tree_in_pipeline(self):
        ...
        command2 = CommandTree(Command(name='command2'))
        command3 = CommandTree(Command(name='command3'))
        command4 = CommandTree(Command(name='command4'))
...
class TestCommandTreeConstructorInnerMethods(TestCase):
    ...
    def test_get_subsearches(self):
        ...
        self.assertEqual(subsearches[0].value[0].name, 'otstats')
        self.assertEqual(subsearches[1].value[0].name, 'readfile')
        self.assertEqual(subsearches[2].value[0].name, 'otstats')
